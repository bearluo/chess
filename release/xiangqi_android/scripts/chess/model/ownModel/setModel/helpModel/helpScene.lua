...
HelpScene.create = function(self)
    ...
    if data then
        self.m_chess_introduce[3][1] = string.format("     %s=%d-%d      %s=%d-%d",data[1].name,data[1].min,data[1].max,data[2].name,data[2].min,data[2].max);
        self.m_chess_introduce[3][2] = string.format("     %s=%d-%d   %s=%d-%d",data[3].name,data[3].min,data[3].max,data[4].name,data[4].min,data[4].max); 
        self.m_chess_introduce[3][3] = string.format("     %s=%d-%d   %s=%d-%d",data[5].name,data[5].min,data[5].max,data[6].name,data[6].min,data[6].max); 
        self.m_chess_introduce[3][4] = string.format("     %s=%d-%d   %s=%d-%d",data[7].name,data[7].min,data[7].max,data[8].name,data[8].min,data[8].max); 
        self.m_chess_introduce[3][5] = string.format("     %s=%d及以上。",data[9].name,data[9].min); 
    end
        ...
        if index == 3 then
            for i = 1, HelpScene.CHESS_NUM do
                if self.m_chess_introduce[index][i] then 
                    local chess_introduce = new(TextView,self.m_chess_introduce[index][i],HelpScene.TEXT_WIDTH,nil,kAlignLeft,nil,22,135,100,95);
