...
PhpConfig.FEEDBACK_URL = "https://feedback.boyaagame.com/api/api.php";   --   反馈地址
...
PhpConfig.new_developTest = "http://chess.by.com/chess/" -- 新测试服
PhpConfig.new_developMainUrl = "http://cnchess.17c.cn/chess/"-- 新正式服

PhpConfig.h5_developTest = "https://chess153.by.com/chess/h5/";--测试服H5地址
PhpConfig.h5_developMainUrl = "https://cnchess.17c.cn/chess/h5/";--正式服H5地址
...
PhpConfig.initURL = function()
    ...
    PhpConfig.NEW_SCORE_RANK_URL = "https://192.168.100.153/chess/"; --获取积分排行榜列表 新
...
PhpConfig.setUUID = function(uuid)
    PhpConfig.uuid = uuid;
end
PhpConfig.getUUID = function()
    return PhpConfig.uuid or System.getGuid();
end
...
PhpConfig.getMnick= function()
    return PhpConfig.mnick or "博雅象棋";
end
...
PhpConfig.iOS_Bundle_id = dict_get_string("php_config_bundle_id","bundle_id") or "";
if PhpConfig.iOS_Bundle_id == "com.boyaa.chineseChess" then
    PhpConfig.SID_IPHONE = 101;  -- iPhone简体
    PhpConfig.SID_IPAD = 301;  -- iPad简体
elseif PhpConfig.iOS_Bundle_id == "com.boyaa.indiv.chineseChess" then
    PhpConfig.SID_IPHONE = 103;  -- iPhone简体
    PhpConfig.SID_IPAD = 104;  -- iPad简体
else 
    PhpConfig.SID_IPHONE = 101;  -- iPhone简体
    PhpConfig.SID_IPAD = 301;  -- iPad简体
end
...
PhpConfig.SID_vivo = 214;         --步步高

PhpConfig.APPID_vivo = "0";    -- 推广渠道ID
PhpConfig.APPKEY_vivo = "0";   --推广渠道key
PhpConfig.BID_vivo = "_vivo";
...
if kPlatform == kPlatformIOS then
    ...
    if PhpConfig.iOS_Bundle_id == "com.boyaa.chineseChess" then
        PhpConfig.BID_IPAD = "I_301";
        PhpConfig.BID_IPHONE = "b7";
    elseif PhpConfig.iOS_Bundle_id == "com.boyaa.indiv.chineseChess" then
        PhpConfig.BID_IPAD = "I_104";
        PhpConfig.BID_IPHONE = "I_103";
    else
        PhpConfig.BID_IPAD = "I_301";
        PhpConfig.BID_IPHONE = "b7";
    end
