...
--棋局状态   1停止 2正在下棋 3抢先 4让子 5设置局时 6等待局时回复 7让子确认阶段
STATUS_TABLE_STOP = 1;
...
TO_WECHAT_WEB_PAGE = "ToWechatWebPage" --打开微信网页
...
HALL_MODEL_OFFLINE_BTN = "hall_model_offline_btn" --离线大厅按钮
...
HALL_MODEL_COMPETE_BTN = "hall_model_compete_btn"  --大厅比赛争霸按钮
HALL_MODEL_WATCH_BTN = "hall_model_watch_btn"  --大厅观战按钮
HALL_MODEL_TASK_BTN = "hall_model_task_btn"  --大厅任务按钮
HALL_MODEL_RANK_BTN = "hall_model_rank_btn"  --大厅排行榜按钮
HALL_MODEL_SHARE_BTN = "hall_model_share_btn"  --大厅分享按钮
HALL_MODEL_HEAD_BTN = "hall_model_head_btn"  --大厅--头像图标
HALL_MODEL_GOLD_BTN = "hall_model_gold_btn"  --大厅--顶部金币资产图标
HALL_MODEL_SCORE_BTN = "hall_model_score_btn"  --大厅--顶部积分图标
HALL_MODEL_FRIENDS_BTN = "hall_model_friends_btn"  --大厅--好友图标
HALL_MODEL_MAIL_BTN = "hall_model_mail_btn"  --大厅--消息图标
HALL_MODEL_QIPU_BTN = "hall_model_qipu_btn"  --大厅--棋谱图标
HALL_MODEL_CHAT_BTN = "hall_model_chat_btn"  --大厅--聊天入口图标
HALL_MODEL_MORE_BTN = "hall_model_more_btn"  --大厅--左下更多图标
HALL_MODEL_MORE_RANK_BTN = "hall_model_more_rank_btn"  --大厅--更多--排行榜图标
HALL_MODEL_MORE_FEEDBACK_BTN = "hall_model_more_feedback_btn"  --大厅--更多--反馈图标
HALL_MODEL_MORE_SET_BTN = "hall_model_more_set_btn"  --大厅--更多--设置图标
HALL_MODEL_MORE_ABOUT_BTN = "hall_model_more_about_btn"  --大厅--更多--关于图标
...
ONLINE_MODEL_MONEY_MATCH_BTN  = "online_money_match_btn_click"; --联网速战赛按钮点击

-- 棋局开始流程
ONLINE_READY_PROCESS_SURE_TIMESET = "online_ready_process_sure_timeset"--开局准备--确认棋局配置
ONLINE_READY_PROCESS_GIVEUP_TIMESET = "online_ready_process_giveup_timeset"---开局准备--放弃选择配置
ONLINE_READY_PROCESS_SURE_TIMESET_INFO = "online_ready_process_sure_timeset_info"--开局准备--同意棋局配置方案
ONLINE_READY_PROCESS_GIVEUP_TIMESET_INFO = "online_ready_process_giveup_timeset_info"--开局准备--放弃棋局配置方案
ONLINE_READY_PROCESS_SURE_FORESTALL = "online_ready_process_sure_forestall"--开局准备--加注抢先
ONLINE_READY_PROCESS_GIVEUP_FORESTALL = "online_ready_process_giveup_forestall"--开局准备--不加注抢先
ONLINE_READY_PROCESS_SURE_HANDICAP = "online_ready_process_sure_handicap"--开局准备--让子翻倍
ONLINE_READY_PROCESS_GIVEUP_HANDICAP = "online_ready_process_giveup_handicap"--开局准备--拒绝让子

-- 单机统计
OFFLINE_CONSOLE_GUNS_BTN_CLICK = "offline_console_guns_btn_click" --1.使用火炮开始按钮点击次数；
OFFLINE_CONSOLE_TIPS_BTN_CLICK = "offline_console_tips_btn_click"--2.锦囊道具按钮点击次数；
OFFLINE_CONSOLE_TASK_BTN_CLICK = "offline_console_task_btn_click"--3.任务按钮点击次数；
OFFLINE_CONSOLE_DAPU_BTN_CLICK = "offline_console_dapu_btn_click"--4.复盘按钮点击次数。


ONLINE_MATCH_SUCCESS_TIME = "online_match_success_time" -- 联网匹配成功时间


ROOM_READYING_HANDICAP_TRUE = "room_readying_handicap_true" -- 开局准备--让子操作
ROOM_READYING_FORESTALL_TRUE = "room_readying_forestall_true" -- 开局准备--加倍操作
...
DAILY_SIGN_DATA_CALLBACK = "daily_sing_data_callback"--每日签到数据回调

THANSIZEDIALOG_BTN_CLICK = "thansizedialog_btn_click"--小游戏按钮点击次数（打开小游戏）
THANSIZEDIALOG_BTN_THAN_SIZE = "thansizedialog_btn_than_size"--小游戏选择大小向服务器发包