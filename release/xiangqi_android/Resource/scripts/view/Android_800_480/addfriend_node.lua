addfriend_node=
{
	name="addfriend_node",type=0,typeName="View",time=0,x=0,y=0,width=618,height=131,visible=1,fillParentWidth=0,fillParentHeight=0,nodeAlign=kAlignCenter,
	{
		...
		{
			name="vip_frame",type=1,typeName="Image",time=100665415,x=0,y=0,width=110,height=110,visible=0,fillParentWidth=0,fillParentHeight=0,nodeAlign=kAlignCenter,file="vip/vip_110.png"
		}
	},
	{
		name="name",type=4,typeName="Text",time=97654682,x=138,y=-32,width=200,height=40,visible=1,fillParentWidth=0,fillParentHeight=0,nodeAlign=kAlignLeft,fontSize=30,textAlign=kAlignLeft,colorRed=80,colorGreen=80,colorBlue=80,string=[[无敌小次郎]]
	},
	{
	...
	{
		name="id",type=4,typeName="Text",time=97654824,x=205,y=33,width=200,height=28,visible=1,fillParentWidth=0,fillParentHeight=0,nodeAlign=kAlignLeft,fontSize=24,textAlign=kAlignLeft,colorRed=125,colorGreen=80,colorBlue=65,string=[[ID:8488250]]
	},
	{
	...
	{
		name="follow_handler",type=0,typeName="View",time=143707134,x=413,y=38,width=185,height=58,visible=1,fillParentWidth=0,fillParentHeight=0,nodeAlign=kAlignTopLeft
	},
	{
		name="fans_tip",type=4,typeName="Text",time=144467755,x=451,y=99,width=0,height=0,visible=1,fillParentWidth=0,fillParentHeight=0,nodeAlign=kAlignTopLeft,fontSize=20,textAlign=kAlignCenter,colorRed=80,colorGreen=80,colorBlue=80,string=[[来自您的粉丝]]
	}
}