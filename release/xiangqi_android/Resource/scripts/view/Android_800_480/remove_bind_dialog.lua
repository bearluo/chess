remove_bind_dialog=
{
	...
	},
	{
		...
		},
		{
			...
			{
				name="text",type=4,typeName="Text",time=110363133,x=0,y=0,width=200,height=150,visible=1,fillParentWidth=0,fillParentHeight=0,nodeAlign=kAlignCenter,fontSize=36,textAlign=kAlignCenter,colorRed=240,colorGreen=230,colorBlue=210,string=[[知道了]]
			}
		},
		{
		...
		},
		{
			...
			{
				name="text",type=4,typeName="Text",time=110369451,x=0,y=0,width=200,height=150,visible=1,fillParentWidth=0,fillParentHeight=0,nodeAlign=kAlignCenter,fontSize=36,textAlign=kAlignCenter,colorRed=240,colorGreen=230,colorBlue=210,string=[[知道了]]
			}
		}
	}
}