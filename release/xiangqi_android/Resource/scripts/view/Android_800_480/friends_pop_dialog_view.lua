friends_pop_dialog_view=
{
	...
	{
		name="bg",type=1,typeName="Image",time=86925647,x=0,y=0,width=720,height=1067,visible=1,fillParentWidth=1,fillParentHeight=0,nodeAlign=kAlignBottom,file="common/background/dialog_bg_1.png",gridLeft=50,gridRight=50,gridTop=50,gridBottom=50,
		{
		...
		},
		{
			...
			{
				name="text",type=4,typeName="Text",time=110111654,x=0,y=0,width=200,height=84,visible=1,fillParentWidth=0,fillParentHeight=0,nodeAlign=kAlignCenter,fontSize=40,textAlign=kAlignCenter,colorRed=240,colorGreen=230,colorBlue=210,string=[[去添加]]
			}
		},
		{
