watch_dialog_view=
{
	...
	},
	{
		...
		{
			name="chat_info_view",type=0,typeName="View",time=110605123,x=0,y=90,width=720,height=245,visible=1,fillParentWidth=1,fillParentHeight=0,nodeAlign=kAlignBottom,
			{
				name="chat_bg",type=1,typeName="Image",time=110605124,x=0,y=0,width=700,height=250,visible=1,fillParentWidth=0,fillParentHeight=0,nodeAlign=kAlignBottom,file="common/background/comment_bg.png",gridLeft=50,gridRight=50,gridTop=50,gridBottom=50,
				{
					name="chat_info",type=0,typeName="View",time=110605125,x=0,y=0,width=700,height=212,visible=1,fillParentWidth=0,fillParentHeight=0,nodeAlign=kAlignTopLeft
				},
				{
		...
		{
			name="send_chat_view",type=0,typeName="View",time=110605133,x=0,y=0,width=720,height=155,visible=1,fillParentWidth=1,fillParentHeight=0,nodeAlign=kAlignBottom,
			{
				name="chat_bg",type=1,typeName="Image",time=110605134,x=0,y=0,width=720,height=100,visible=1,fillParentWidth=1,fillParentHeight=0,nodeAlign=kAlignBottom,file="online/room/bottom_menu_bg.png",gridLeft=128,gridRight=128,gridTop=55,gridBottom=55
			},
			{
				name="input_view",type=0,typeName="View",time=110605135,x=0,y=0,width=720,height=100,visible=1,fillParentWidth=0,fillParentHeight=0,nodeAlign=kAlignBottom,
				{
					name="chat_book",type=2,typeName="Button",time=110605136,x=301,y=22,width=86,height=72,visible=1,fillParentWidth=0,fillParentHeight=0,nodeAlign=kAlignTop,file="common/button/msg_nor.png",file2="common/button/msg_pre.png",
					{
						name="Text1",type=4,typeName="Text",time=110605137,x=0,y=0,width=102,height=34,visible=0,fillParentWidth=0,fillParentHeight=0,nodeAlign=kAlignCenter,fontSize=34,textAlign=kAlignCenter,colorRed=245,colorGreen=235,colorBlue=210,string=[[常用语]]
					}
				},
				{
					name="send_btn",type=2,typeName="Button",time=110605138,x=566,y=33,width=128,height=58,visible=0,fillParentWidth=0,fillParentHeight=0,nodeAlign=kAlignTopLeft,file="common/button/dialog_btn_3_normal.png",file2="common/button/dialog_btn_3_press.png",
					{
				...
				{
					name="edit_bg",type=1,typeName="Image",time=110605140,x=84,y=28,width=512,height=62,visible=1,fillParentWidth=0,fillParentHeight=0,nodeAlign=kAlignTopLeft,file="common/background/input_bg_2.png",gridLeft=33,gridRight=33,gridTop=31,gridBottom=31,
					{
						name="input_edit",type=6,typeName="EditText",time=110605141,x=13,y=13,width=480,height=36,visible=1,fillParentWidth=0,fillParentHeight=0,nodeAlign=kAlignTopLeft,fontSize=32,textAlign=kAlignLeft,colorRed=80,colorGreen=80,colorBlue=80,string=[[]]
					}
				},
				{
					name="chat_book_bg",type=1,typeName="Image",time=110605142,x=0,y=80,width=696,height=478,visible=0,fillParentWidth=0,fillParentHeight=0,nodeAlign=kAlignBottom,file="online/room/chat/chat_book_bg.png",gridLeft=64,gridRight=64,gridTop=64,gridBottom=64
				},
				{
					name="chat_book_view",type=0,typeName="ScrollView",time=110605143,x=0,y=80,width=696,height=478,visible=0,fillParentWidth=0,fillParentHeight=0,nodeAlign=kAlignBottom
				},
				{
					name="backButton",type=2,typeName="Button",time=137658026,x=3,y=23,width=76,height=76,visible=1,fillParentWidth=0,fillParentHeight=0,nodeAlign=kAlignTopLeft,file="common/button/back_btn.png"
				}
			}
		}
	},
	{
		...
		{
			name="bg",type=1,typeName="Image",time=110712338,x=0,y=0,width=720,height=1280,visible=1,fillParentWidth=1,fillParentHeight=1,nodeAlign=kAlignTopLeft,file="drawable/black.png"
		},
		{
