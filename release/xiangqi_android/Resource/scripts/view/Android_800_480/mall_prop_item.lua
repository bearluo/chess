mall_prop_item=
{
	name="mall_prop_item",type=0,typeName="View",time=0,x=0,y=0,width=678,height=170,visible=1,fillParentWidth=0,fillParentHeight=0,nodeAlign=kAlignTopLeft,
	{
	...
	{
		name="btn",type=2,typeName="Button",time=121425205,x=0,y=0,width=678,height=170,visible=1,fillParentWidth=1,fillParentHeight=1,nodeAlign=kAlignTopLeft,file="drawable/blank.png"
	},
	{
	...
	{
		name="exchange_over_img",type=1,typeName="Image",time=144498413,x=224,y=50,width=174,height=64,visible=0,fillParentWidth=0,fillParentHeight=0,nodeAlign=kAlignTop,file="common/button/exchange_over_btn.png"
	}
}