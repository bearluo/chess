friend_chat_dialog=
{
	name="friend_chat_dialog",type=0,typeName="View",time=0,x=0,y=0,width=0,height=0,visible=1,fillParentWidth=1,fillParentHeight=1,nodeAlign=kAlignTopLeft,
	{
		...
		},
		{
			...
			{
				name="send_btn",type=2,typeName="Button",time=97936456,x=250,y=8,width=128,height=58,visible=1,fillParentWidth=0,fillParentHeight=0,nodeAlign=kAlignCenter,file="common/button/dialog_btn_3_normal.png",file2="common/button/dialog_btn_3_press.png",
				{
		...
		{
			name="content_view",type=0,typeName="View",time=97936672,x=0,y=127,width=610,height=810,visible=1,fillParentWidth=0,fillParentHeight=0,nodeAlign=kAlignTop
		},
		{
