...
Effects = {
    ...
    AUDIO_SEND_EGG = 49;  ----鸡蛋动画
    AUDIO_SEND_FLOWER = 50;  ----鲜花动画
    AUDIO_SEND_KISS = 51;  ----飞吻动画
    AUDIO_SEND_CARD = 52;  ----金卡动画
    AUDIO_SEND_BMOB = 53;  ----炸弹动画
}
...
EffectsFileMap = {
    ...
    [Effects.AUDIO_SEND_EGG] = "audio_throw_egg_prop_effect";
    [Effects.AUDIO_SEND_FLOWER] = "audio_send_flowers_prop_effect";
    [Effects.AUDIO_SEND_KISS] = "audio_send_kiss_prop_effect";
    [Effects.AUDIO_SEND_CARD] = "audio_send_card_prop_effect";
    [Effects.AUDIO_SEND_BMOB] = "audio_send_bmob_prop_effect";
