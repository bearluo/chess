...
function ActivityController:refreshDailyItem(taskId,data,isDailyTask)
    self:updateView(ActivityScene.s_cmds.updateDailyItemStatus,taskId,data,isDailyTask);
end

function ActivityController:refreshGrowTaskItem(taskId,data,isDailyTask)
    self:updateView(ActivityScene.s_cmds.updateGrowItemStatus,taskId,data,isDailyTask);
end
