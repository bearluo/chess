...
ActivityManager.setMode = function(debug)
    if debug then
	    ActivityManager.config.get_related = "https://192.168.204.68/operating/web/index.php?m=activities&p=actrelated&appid=" .. ActivityManager.appid .. "&";
	    ActivityManager.config.FirstUrl = "https://192.168.204.68/operating/web/index.php?m=activities&p=index&appid=" .. ActivityManager.appid .. "&";
	    ActivityManager.config.CountUrl = "https://192.168.204.68/operating/web/index.php?m=activities&p=actrelated&appid=" .. ActivityManager.appid .. "&";
	    ActivityManager.config.SendPHPUrl = "https://192.168.204.70/apps/interface.php?m=data&p=initdata&appid=" .. ActivityManager.appid .. "&";
	    ActivityManager.config.SecondUrl = "https://192.168.204.70/apps/interface.php?m=apps&p=data&appid=" .. ActivityManager.appid .. "&";
	    ActivityManager.config.img = 'https://192.168.204.68/web/cdn/ns/xqimod/';
	    ActivityManager.config.img_old = 'https://192.168.204.68/web/cdn/';
	    ActivityManager.config.h5_develop = "https://chess153.by.com/chess/h5/";
	    ActivityManager.config.old_act = 'https://192.168.204.68/operating/web/index.php?m=activities&p=show&appid=' .. ActivityManager.appid .. "&";
    else
	    ActivityManager.config.get_related = "https://mvusspcs01.ifere.com/?m=activities&p=actrelated&appid=" .. ActivityManager.appid .. "&";
	    ActivityManager.config.FirstUrl = "https://mvusspcs01.ifere.com/?m=activities&p=index&appid=" .. ActivityManager.appid .. "&";
	    ActivityManager.config.CountUrl = "https://mvusspcs01.ifere.com/?m=activities&p=actrelated&appid=" .. ActivityManager.appid .. "&";
	    ActivityManager.config.SendPHPUrl = "https://mvusspcs01.ifere.com/interface.php?m=data&p=initdata&appid=" .. ActivityManager.appid .. "&";
	    ActivityManager.config.SecondUrl = "https://mvusspcs01.ifere.com/interface.php?m=apps&p=data&appid=" .. ActivityManager.appid .. "&";
	    ActivityManager.config.img = 'https://cache.17c.cn/mobile/activities/ns/xqimod/';
	    ActivityManager.config.img_old = 'https://cache.17c.cn/mobile/activities/';
	    ActivityManager.config.h5_develop = "https://cnchess.17c.cn/chess/h5/";
	    ActivityManager.config.old_act = 'https://mvusspcs01.ifere.com/?m=activities&p=show&appid=' .. ActivityManager.appid .. "&";
    end
end
