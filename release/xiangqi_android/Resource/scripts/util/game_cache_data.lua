...
GameCacheData.DARKTOGGLE = "darktoggle";  -- 夜间模式开关
...
GameCacheData.CONSOLE_FEN = "console_fen";  --单机的历史fen
GameCacheData.CONSOLE_CAN_EXCHANGE_TIPS = "console_can_exchange_tips";  --单机是否能兑换锦囊
GameCacheData.CONSOLE_TIPS_NUM = "console_tips_num";  --单机锦囊个数
...
GameCacheData.ENDGAME_LATETST_SELECT_TID  = "endgame_latetst_select_tid_v1_";  --用户选择的关卡
GameCacheData.ENDGAME_LATETST_SELECT_POS  = "endgame_latetst_select_pos_v1_";  --用户选择的关卡
...
GameCacheData.Mall_SHOP_VERSION = "Mall_SHOP_VERSION4";
GameCacheData.MALL_GOODS_LIST = "MALL_GOODS_LIST4"; --金币商品列表数据
...
GameCacheData.PROP_LIST_VERSION  = "prop_list_version2";
GameCacheData.PROP_LIST = "prop_list2";
...
GameCacheData.CHAT_IS_HAS_UNREAD_MSG = "chat_is_has_unread_msg_";
GameCacheData.CHAT_INVITE_MSG = "chat_invite_msg";
...
-- 新手评测数据
GameCacheData.EVALUATION_DATA_ = "evaluation_data_";
...
GameCacheData.FRIEND_USER_COMBAT = "friend_user_combat_";
GameCacheData.FRIEND_USER_BLACKLIST = "friend_user_blacklist_";
-- friends data end
-- usercache data
GameCacheData.USER_CACHE_DATA_ = "user_cache_data_";
...
GameCacheData.LOGIN_TIME = "login_time"; -- 用来区分首次启动游戏
GameCacheData.FORCEUPDATE = "check_updateV2";
...
GameCacheData.LOCATE_LOCATION_INFO = "locate_location_info";
GameCacheData.GET_CITY_DATA = "is_get_city_data";  -- 版本号
GameCacheData.GET_NOTICE_AUTHOR = "get_notice_author";
...
-- 联网房间帮助tips
GameCacheData.ONLINE_SCENE_TIPS_ = "online_scene_tips_"; -- 上次显示版本

-- 礼物道具
GameCacheData.GIFT_DATA = "gift_data"

-- 竞技场提示
GameCacheData.ARENA_TIPS_ = "arena_tips_"

-- 竞技场提示
GameCacheData.SHOW_REMIND_SET_NICKNAME_DIALOG_ = "show_remind_set_nickname_dialog_"
