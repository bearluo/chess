...
--	self.m_music_toggle = self.m_content_view:getChildByName("music_toggle_view"):getChildByName("toggle_btn");
    ...
    self.m_dark_toggle =  self.m_content_view:getChildByName("dark_toggle_view"):getChildByName("toggle_btn");
...
--    self.m_music_toggle:setOnClick(self,self.onMusicToggleClick);
    ...
    self.m_dark_toggle:setOnClick(self, self.onDarkToggleClick);
...
SettingDialog.onDarkToggleClick = function(self)
	print_string("SettingDialog.onTouch");
	SettingInfo.getInstance():setDarkToggle(not SettingInfo.getInstance():getDarkToggle());
    SetScene.setChecked(self.m_dark_toggle,SettingInfo.getInstance():getDarkToggle());
...
--	SettingDialog.setChecked(self.m_music_toggle,self.m_music_bool);
    ...
    SetScene.setChecked(self.m_dark_toggle,self.m_dark_bool);
