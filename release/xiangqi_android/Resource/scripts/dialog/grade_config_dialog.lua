require(VIEW_PATH .. "grade_config_dialog_view_new");
require(BASE_PATH.."chessDialogScene")

GradeConfigDialog = class(ChessDialogScene,false);

GradeConfigDialog.ctor = function(self)
	super(self,grade_config_dialog_view_new);
	self.m_root_view = self.m_root;
    --self.m_bg_view = self.m_root_view:getChildByName("new_style_view"):getChildByName("bg");
    --self:setShieldClick(self,self.dismiss);
    --self.m_bg_view:setEventTouch(self.m_bg_view,function() end);

    self.m_introduction_view = self.m_root_view:getChildByName("new_style_view"):getChildByName("content_view"):getChildByName("introduction_view")
    ...
    self.m_content_view = self.m_root_view:getChildByName("new_style_view"):getChildByName("content_view"):getChildByName("content");
    ...
    self.m_close_btn = self.m_root_view:getChildByName("new_style_view"):getChildByName("close_btn");
